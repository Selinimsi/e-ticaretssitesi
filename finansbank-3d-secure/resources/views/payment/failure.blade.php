...
<head>
    ...
    <style>
        ...
        .icon { width: 80px; height: 80px; background: #f8d7da; color: #dc3545; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 40px; margin: 0 auto 20px; }
...
<body>
    <div class="card">
        ...
        <p>Siparişinizin ({{ $orderId }}) ödemesi sırasında bir hata oluştu. Lütfen tekrar deneyiniz.</p>
